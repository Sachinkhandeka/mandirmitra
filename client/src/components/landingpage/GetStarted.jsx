...
export  default function GetStarted() {
    return (
        <section  className="flex items-center justify-center flex-col mt-8 text-black" data-aos="flip-left" data-aos-easing="ease-out-cubic" data-aos-duration="2000" >
            <h1 className="text-2xl md:text-6xl font-bold font-sans text-black my-6" >Get started for free</h1>
            <p className="text-center px-4" >Shuruat karein abhi, aur apne mandir ka management aasan banayein. Team aur features ko baad mein add karein!</p>
